		  ...
		  <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="patients.php" class="" aria-expanded="false">
						<div class="menu-icon">
                    ...
                    <div class="menu-icon">
						...
						<ul aria-expanded="false">
							<li><a href="add_tests.php">Add Tests</a></li>
							<li><a href="list_tests.php">List Tests</a></li>
						</ul>
					</li>
					<li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                    <div class="menu-icon">
						...
						<ul aria-expanded="false">
							<li><a href="createcoupons.php">Create Coupons</a></li>
							<li><a href="list_coupons.php">List Coupons</a></li>
						</ul>
					</li>
