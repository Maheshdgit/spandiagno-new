       ...
       <form id = "addtst">
          <div class="row">
             <div class="mb-3 col-md-6">
                ...
                <input type="text" name="tst-ttle" class="form-control input-rounded" value="<?php echo $title;?>">
             </div>
             <div class="mb-3 col-md-6">
          ...
          <div class="row">
             <div class="mb-3 col-md-6">
                ...
                <input type="text" name="tst-cost" id="mrp" class="form-control input-rounded" value="<?php echo $mrp;?>">
             </div>
             <div class="mb-3 col-md-6">
                <label class="form-label">Test short Description</label>
                <input type="text" name="tst-shrtdesc" class="form-control input-rounded" value="<?php echo $shdesc;?>">
             </div>
          </div>
          <div class="row">
             <div class="mb-3 col-md-6">
                <label class="form-label">Test Preparation </label>
                <input type="text" name="tst-prep" class="form-control input-rounded" value="<?php echo $prep;?>">
             </div>
             <div class="mb-3 col-md-6">
                <label class="form-label">Test Reports Time</label>
                <input type="text" name="tst-rep" class="form-control input-rounded" value="<?php echo $reptime;?>">
             </div>
          </div>
          <div class="row">
             <div class="mb-3 col-md-6">
          ...
          <div class="row" id="discountfields" style="display:none;">
             <div class="mb-3 col-md-6">
                ...
                <input type="number" name="tst-dcnt" id="discnt" class="form-control input-rounded" value="<?php echo $dis;?>">
             </div>
             <div class="mb-3 col-md-6">
                <label class="form-label">MRP after Discount (for your reference) </label>
                <input type="text" name="discounted_mrp" id="tstdisc" class="form-control input-rounded" value="<?php echo $dpmrp;?>" disabled>
             </div>
          </div>
          <div class="row">
             <div class="mb-3 col-md-6">
