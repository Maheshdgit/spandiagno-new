							...
							<div class="row align-items-center justify-content-lg-start justify-content-md-between">
								<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 order-last">
									<div class="slider-image mask-image">
										 <!--<img src="assets/images/slider/span_1.jpg" alt="image_not_found"> -->
									</div>
								</div>
...
<?php
			...
			<!--<section class="section_health_pack py-lg-3 pb-lg-5 pb-3">-->
			<!--    <div class="section-title text-center mb-70">-->
			<!--			<h2 class="title-text mb-3">Health Packages</h2>-->
			<!--			<p class="mb-0"></p>-->
			<!--		</div>-->
   ...
   <!--                 <div class="py-4 bg-light-grey br-30 ">-->
   <!--                     <h3 class="font-bold cl-dark-blue text-center  m-0">STARTER</h3>-->
   <!--                     <div class="d-flex justify-content-center align-content-center pt-3">-->
   <!--                         <div class="home_linear_border  ">-->
   <!--                             <div>-->
   <!--                                 <p class="font-bold fs-20 cl-dark-blue d-flex justify-content-center align-content-center align-items-center m-0">-->
   <!--                                     Price</p>-->
                                        
                                 
                                    
   <!--                                 <h3 class="fs-40 cl-dark-blue font-bold d-flex justify-content-center m-0 ">-->
   <!--                                     ₹700.00</h3>-->
                                    
   <!--                                 <p class="d-flex justify-content-center align-content-center align-items-center m-0 fs-18 cl-dark-blue font-bold">-->
   <!--                                     Includes 10-->
   <!--                                     Tests-->
   <!--                                 </p>-->
   <!--                             </div>-->
   ...
   <!--                         <a href="/health-packages/starter"><button class="home_pack_viewpack py-2 fs-16 font-bold br-50 ">VIEW PACK</button></a>-->
   <!--                     </div>-->
   <!--                 </div>-->
   <!--             </div>-->
   ...
   <!--             <div class="col-xl-3  col-lg-4 col-md-6 pt-3">-->
   <!--                 <div class="py-4 bg-light-grey br-30 ">-->
   <!--                     <h3 class="font-bold cl-dark-blue text-center  m-0">BASIC</h3>-->
   <!--                     <div class="d-flex justify-content-center align-content-center pt-3">-->
   <!--                         <div class="home_linear_border  ">-->
   <!--                             <div>-->
   <!--                                 <p class="font-bold fs-20 cl-dark-blue d-flex justify-content-center align-content-center align-items-center m-0">-->
   ...
   <!--                     </div>-->
   <!--                     <div class="d-flex justify-content-center pt-3">-->
   <!--                         <a href="/health-packages/basic"><button class="home_pack_viewpack py-2 fs-16 font-bold br-50 ">VIEW PACK</button></a>-->
   <!--                     </div>-->
   <!--                 </div>-->
   <!--             </div>-->
   ...
   <!--             <div class="col-xl-3  col-lg-4 col-md-6 pt-3">-->
   <!--                 <div class="py-4 bg-light-grey br-30 ">-->
   <!--                     <h3 class="font-bold cl-dark-blue text-center  m-0">STANDARD</h3>-->
   <!--                     <div class="d-flex justify-content-center align-content-center pt-3">-->
   <!--                         <div class="home_linear_border  ">-->
   <!--                             <div>-->
   <!--                                 <p class="font-bold fs-20 cl-dark-blue d-flex justify-content-center align-content-center align-items-center m-0">-->
   ...
   <!--                     </div>-->
   <!--                     <div class="d-flex justify-content-center pt-3">-->
   <!--                         <a href="/health-packages/standard"><button class="home_pack_viewpack py-2 fs-16 font-bold br-50 ">VIEW PACK</button></a>-->
   <!--                     </div>-->
   <!--                 </div>-->
   <!--             </div>-->
   ...
   <!--             <div class="col-xl-3  col-lg-4 col-md-6 pt-3">-->
   <!--                 <div class="py-4 bg-light-grey br-30 ">-->
   <!--                     <h3 class="font-bold cl-dark-blue text-center  m-0">PRIME</h3>-->
   <!--                     <div class="d-flex justify-content-center align-content-center pt-3">-->
   <!--                         <div class="home_linear_border  ">-->
   <!--                             <div>-->
   <!--                                 <p class="font-bold fs-20 cl-dark-blue d-flex justify-content-center align-content-center align-items-center m-0">-->
   ...
   <!--                     </div>-->
   <!--                     <div class="d-flex justify-content-center pt-3">-->
   <!--                         <a href="/health-packages/prime"><button class="home_pack_viewpack py-2 fs-16 font-bold br-50 ">VIEW PACK</button></a>-->
   <!--                     </div>-->
   <!--                 </div>-->
   <!--             </div>-->
   ...
   <!--             <div class="col-xl-3  col-lg-4 col-md-6 pt-3">-->
   <!--                 <div class="py-4 bg-light-grey br-30 ">-->
   <!--                     <h3 class="font-bold cl-dark-blue text-center  m-0">PREMIUM</h3>-->
   <!--                     <div class="d-flex justify-content-center align-content-center pt-3">-->
   <!--                         <div class="home_linear_border  ">-->
   <!--                             <div>-->
   <!--                                 <p class="font-bold fs-20 cl-dark-blue d-flex justify-content-center align-content-center align-items-center m-0">-->
   ...
   <!--                     </div>-->
   <!--                     <div class="d-flex justify-content-center pt-3">-->
   <!--                         <a href="/health-packages/premium"><button class="home_pack_viewpack py-2 fs-16 font-bold br-50 ">VIEW PACK</button></a>-->
   <!--                     </div>-->
   <!--                 </div>-->
   <!--             </div>-->
   ...
   <section class="shop-section sec-ptb-50 decoration-wrap clearfix">
				<div class="container">
					<div class="section-title text-center mb-30">
						<h2 class="title-text mb-3">Health Packagess</h2>
						<p class="mb-0"></p>
					</div>
               ...
               //$unq=$_GET['tst_id'];
                ...
                ?>
								...
								<div class="col-lg-2 col-md-4 col-sm-6 col-xs-12 crd">
								 <div class="card bg-light rounded shadow crds" >
                    <div class="card-body product-grid p-4 cb">
					
					
                        <h5 class="crd-title-package">
						...
						<div class="mt-1">
							...
							<!--<span class="rel-icon">-->
							   <!--<i class="las la-vial"></i> -->
							    <!--<img src="assets/images/blood-count-test.png" class="image_icon"></span> -->
							    </p>
             ...
             <div class="col-md-12 p-0">
                 <div class="row">
                     <div class="col-md-12">
                <span class="crd-prc mb-30">Price : 
                <!--<span class="" id="old" >-->
                    ₹
                    <!--<?php echo $mrp; ?>-->
                    3000
    ...
    <!--            <div class="post-label ul-li-right clearfix">-->
             ...
             <?php
                ...
                ?>
                        ...
                        <div class="mt-1">
							<input type="hidden" name="uid"  value="<?php echo $unqid; ?>" />
                            <button type="button" name="atc"  value="<?php echo $unqid; ?>" class="btn btn-primary crd-btn_package">View Pack</button>
                        </div>
                    </div>
                    </div>
              </div>
